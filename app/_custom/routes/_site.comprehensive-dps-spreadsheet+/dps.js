...
function requestSpreadsheet(startover) {
	...
	if (startover) {
		...
		if (pokebox_checkbox.checked) {
			...
			calculationMethod = function () {
				var pokemon = [];
				var unavailable_checkbox = document.getElementById('ui-hideUnavail-checkbox');
...
function applyEasterEgg(dt) {
	dt.row.add({
		ui_name: createIconLabelSpan("/sites/default/files/2020-03/Ani213MS.png", "Shuckle", 'species-input-with-icon'),
		ui_fmove: "",
		ui_cmove: "",
		ui_dps: Infinity,
		ui_tdo: Infinity,
	...
	// dt.row.add({
	// 	ui_name: createIconLabelSpan("/sites/default/files/2020-03/Ani399MS.png", "Shiny Bidoof", 'species-input-with-icon'),
	// 	ui_fmove: "",
	// 	ui_cmove: "",
	// 	ui_dps: Infinity,
	// 	ui_tdo: Infinity,
	...
	// dt.row.add({
	// 	ui_name: createIconLabelSpan("/sites/default/files/2020-03/Ani132MS.png", "Ditto", 'species-input-with-icon'),
	// 	ui_fmove: "",
	// 	ui_cmove: "",
	// 	ui_dps: Infinity,
	// 	ui_tdo: Infinity,
	...
	dt.row.add({
		...
		label: "Pikachu",
		nickname: "Pikachu",
		ui_name: createIconLabelSpan("/sites/default/files/2020-03/Ani015OD.png", "Pikachu", 'species-input-with-icon'),
		ui_fmove: "",
		ui_cmove: "",
		ui_dps: 10,
		ui_tdo: 100,
